...
namespace ProjectEulerTests
{
    ...
    public class EulerProblemTests
    {
        ...
        [TestMethod]
        public void EulerProblem1ExampleTest()
        {
            //If we list all the natural numbers below 10 that are multiples of 3 or 5, we get 3, 5, 6 and 9. 
            //The sum of these multiples is 23.
            Int32 result = EulerProblems.EulerProblem1Example();

            Assert.AreEqual(23, result);
        }

        [TestMethod]
        public void EulerProblem1SolutionTest()
        {
            //Find the sum of all the multiples of 3 or 5 below 1000.
            Stopwatch watch = Stopwatch.StartNew();
            Int32 result = EulerProblems.EulerProblem1();
        ...
        public void EulerProblem2Solution()
        {
            ...
            Stopwatch watch = Stopwatch.StartNew();
            Int32 result = EulerProblems.EulerProblem2();
