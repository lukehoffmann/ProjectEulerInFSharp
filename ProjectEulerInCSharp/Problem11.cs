...
namespace ProjectEulerInCSharp
{
    public class Problem11
    {
        ...
        public static long HighestProduct()
        {
            var max = 0;
        ...
        public static int RightProduct(int x, int y)
        {
            // These are 1-based indices. Check that we can obtain the numbers we need
            if (x < 1 || x + 3 > 20 ||
                y < 1 || y > 20)
            ...
            return
                Problem11Data[iy][ix] *
                Problem11Data[iy][ix + 1] *
                Problem11Data[iy][ix + 2] *
                Problem11Data[iy][ix + 3];
        }

        public static int DownProduct(int x, int y)
        {
            // These are 1-based indices. Check that we can obtain the numbers we need
            if (x < 1 || x > 20 ||
                y < 1 || y + 3 > 20)
            ...
            return
                Problem11Data[iy][ix] *
                Problem11Data[iy + 1][ix] *
                Problem11Data[iy + 2][ix] *
                Problem11Data[iy + 3][ix];
        }

        public static int RightDownProduct(int x, int y)
        {
            // These are 1-based indices. Check that we can obtain the numbers we need
            if (x < 1 || x + 3 > 20 ||
                y < 1 || y + 3 > 20)
            ...
            return
                Problem11Data[iy][ix] *
                Problem11Data[iy + 1][ix + 1] *
                Problem11Data[iy + 2][ix + 2] *
                Problem11Data[iy + 3][ix + 3];
        }

        public static int LeftDownProduct(int x, int y)
        {
            // These are 1-based indices. Check that we can obtain the numbers we need
            if (x - 3 < 1 || x > 20 ||
                y < 1 || y + 3 > 20)
